...
Construir la API (REST) del caso **Rent&Go** (alquiler de vehículos): vehículos, sucursales, disponibilidad por fechas, reservas y roles cliente/empleado/admin. En la práctica pre-integrador el foco es metodología; el contrato detallado lo verán en el integrador. Referencia: [docs/sprint-2/README.md](../docs/sprint-2/README.md).
