...
> **Práctica pre-integrador:** en la sesión guiada de Scrum el foco es **documentación, tablero, issues y PRs**. Este quickstart replica el mismo estándar que el **proyecto integrador** para que, al pasar a MERN, el flujo ya sea familiar.
